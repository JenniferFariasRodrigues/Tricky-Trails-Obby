...
On IDE choose the option "Import projects". On the folder "General" choose "Existing Projects into workspace" and choose  tricky-trails-obby-oficial folder.

# Choose folder in IDE and run the project
Choose "tricky-trails-obby-oficial" project.
